...
const TrendApp = ({appdata}) => {
    const {image,title,downloads,ratingAvg,id,subtitle} =appdata;
    return (
   <Link to={`./appDetails/${id}`}> 

     <div className="card bg-base-100 w-72 md:w-[380px] shadow-sm h-100">
  <figure className='bg-gray-100 h-[270px]'>
    <img className='md:w-56  object-cover   hover:scale-105 duration-500 '
      src={image}
      alt="Shoes" />
  </figure>
